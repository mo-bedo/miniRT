...
TEST(parse_scene, parse_line)
{
	...
	TEST_ASSERT_EQUAL_FLOAT(-1, mlx.d.c.orientation.x);
	TEST_ASSERT_EQUAL_FLOAT(0, mlx.d.c.orientation.y);
	TEST_ASSERT_EQUAL_FLOAT(0.2, mlx.d.c.orientation.z);
	...
	TEST_ASSERT_EQUAL_FLOAT(0, mlx.d.o.pl[0].orientation.x);
	TEST_ASSERT_EQUAL_FLOAT(1, mlx.d.o.pl[0].orientation.y);
	TEST_ASSERT_EQUAL_FLOAT(0, mlx.d.o.pl[0].orientation.z);
	...
	TEST_ASSERT_EQUAL_FLOAT(0, mlx.d.o.cy[0].orientation.x);
	TEST_ASSERT_EQUAL_FLOAT(0, mlx.d.o.cy[0].orientation.y);
	TEST_ASSERT_EQUAL_FLOAT(1, mlx.d.o.cy[0].orientation.z);
	...
	TEST_ASSERT_EQUAL_FLOAT(1, mlx.d.o.cy[1].orientation.x);
	TEST_ASSERT_EQUAL_FLOAT(1, mlx.d.o.cy[1].orientation.y);
	TEST_ASSERT_EQUAL_FLOAT(1, mlx.d.o.cy[1].orientation.z);
