...
/*   Updated: 2022/10/12 16:38:15 by jbedaux          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_t4	create_infinite_cylinder(t_ray ray, t_object cylinder)
{
	...
	t.t1 = RAY_T_MAX;
	t.t2 = RAY_T_MAX;
	temp_cross = cross(ray.direction, cylinder.orientation);
	temp_cross2 = cross(substract_vectors(ray.origin, cylinder.center), cylinder.orientation);
